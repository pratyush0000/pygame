...
ENDMENU_BUTTON = button.Button(WIDTH // 3 - ENDMENU_IMG.get_width() // 2, HEIGHT // 1.5 - ENDMENU_IMG.get_height() // 2,
                               ENDMENU_IMG, 1)

ENDRESTART_IMG = pygame.transform.scale(pygame.image.load("Assets/restartgamebuttonimg.png").convert_alpha(),
                                        (100, 100))
ENDRESTART_BUTTON = button.Button(WIDTH // 2 - ENDRESTART_IMG.get_width() // 2,
                                  HEIGHT // 1.5 - ENDRESTART_IMG.get_height() // 2, ENDRESTART_IMG, 1)

ENDQUIT_IMG = pygame.transform.scale(pygame.image.load("Assets/quitgamebuttonimg.png").convert_alpha(), (100, 100))
ENDQUIT_BUTTON = button.Button(WIDTH // 1.5 - ENDQUIT_IMG.get_width() // 2,
                               HEIGHT // 1.5 - ENDQUIT_IMG.get_height() // 2, ENDQUIT_IMG, 1)
...
START_BUTTON = button.Button(WIDTH // 2 - START_IMG.get_width() // 2, HEIGHT // 2 - START_IMG.get_height() // 4,
                             START_IMG, 1)
