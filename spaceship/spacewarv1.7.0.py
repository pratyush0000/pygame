...
BULLET_HIT_SOUND =  pygame.mixer.Sound('spaceship/Assets/Grenade+1.mp3')
BULLET__FIRE_SOUND = pygame.mixer.Sound('spaceship/Assets/Gun+Silencer.mp3')
LOBBYSOUND = pygame.mixer.Sound('spaceship/Assets/gamemenusound.mp3')
START_CLICK_SOUND = pygame.mixer.Sound('spaceship/Assets/gamestartsound.mp3')
MENU_CLICK_SOUND = pygame.mixer.Sound('spaceship/Assets/menuclicksound.mp3')
QUIT_CLICK_SOUND = pygame.mixer.Sound('spaceship/Assets/quitclicksound.mp3')
...
ENDMENU_IMG = pygame.transform.scale(pygame.image.load("spaceship/Assets/menubuttonimg.png").convert_alpha(),(100,100))
ENDMENU_BUTTON = button.Button(WIDTH//3-ENDMENU_IMG.get_width()//2   ,   HEIGHT//1.5-ENDMENU_IMG.get_height()//2  ,  ENDMENU_IMG,1)

ENDRESTART_IMG = pygame.transform.scale(pygame.image.load("spaceship/Assets/restartgamebuttonimg.png").convert_alpha(),(100,100))
...
ENDQUIT_IMG = pygame.transform.scale(pygame.image.load("spaceship/Assets/quitgamebuttonimg.png").convert_alpha(),(100,100))
ENDQUIT_BUTTON = button.Button(WIDTH//1.5 - ENDQUIT_IMG.get_width()//2  ,   HEIGHT//1.5 - ENDQUIT_IMG.get_height()//2,ENDQUIT_IMG,1)


SPACEWAR_BG = pygame.transform.scale(pygame.image.load("spaceship/Assets/spacewarbg.png").convert_alpha(),(900,605))
TITLE_IMG = pygame.transform.scale(pygame.image.load("spaceship/Assets/titleimg.png").convert_alpha(),(600,100))

START_IMG = pygame.transform.scale(pygame.image.load("spaceship/Assets/startbutton.png").convert_alpha(),(200,75))
START_BUTTON = button.Button(WIDTH//2-START_IMG.get_width()//2,HEIGHT//2-START_IMG.get_height()//4,START_IMG,1)

QUIT_IMG = pygame.transform.scale(pygame.image.load("spaceship/Assets/quitbutton.png").convert_alpha(),(200,75))
